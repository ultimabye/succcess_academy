...
<head>
    ...
    <meta name="description"
        content="Successor Computer Academy provides best computer education in Sargodha. Our expert team provides practical and industrial training in latest computer technologies.">
    <meta name="keywords"
        content="computer education, computer training, practical training, industrial training, latest computer technologies, computer academy, Sargodha">
    ...
    while ($row = mysqli_fetch_array($result)) {
        ...
        <div id="certificate">
            ...
            <div class="text-center">
                ...
                <p id="recipient">
                    <?php echo $row["stProgram"]; ?>
                </p>
                <p>in</p>
                <p id="recipient">
                    <?php echo $row["stDuration"]; ?>
                </p>
                <p>He/She passed the examination has whole securing</p>
                <p id="recipient">
                    <?php echo $row["stObMarks"]; ?>
                </p>
                <p>Marks Out Of</p>
                <p id="recipient">
                    <?php echo $row["stTotalMarks"]; ?>
                </p>
